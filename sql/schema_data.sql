...
--
-- Table structure for table `isup_capture_20150407`
--
...
CREATE TABLE IF NOT EXISTS `isup_capture_20150407` (
  ...
  `called_ton` int(10) NOT NULL DEFAULT 0,
  `called_npi` int(10) NOT NULL DEFAULT 0,
  `called_inn` int(10) NOT NULL DEFAULT 0,
  `calling_number` varchar(16) NOT NULL DEFAULT '',
  `calling_ton` int(10) NOT NULL DEFAULT 0,
  `calling_npi` int(10) NOT NULL DEFAULT 0,
  `calling_ni` int(10) NOT NULL DEFAULT 0,
  `calling_restrict` int(10) NOT NULL DEFAULT 0,
  `calling_screened` int(10) NOT NULL DEFAULT 0,
  `calling_category` int(10) NOT NULL DEFAULT 0,
  `cause_location` int(10) NOT NULL DEFAULT 0,
  `cause_itu_class` int(10) NOT NULL DEFAULT 0,
  `cause_itu_cause` int(10) NOT NULL DEFAULT 0,
  `event_num` int(10) NOT NULL DEFAULT 0,
  `hop_counter` int(10) NOT NULL DEFAULT 0,
  `nci_satellite` int(10) NOT NULL DEFAULT 0,
  `nci_continuity_check` int(10) NOT NULL DEFAULT 0,
  `nci_echo_device` int(10) NOT NULL DEFAULT 0,
  `fwc_nic` int(10) NOT NULL DEFAULT 0,
  `fwc_etem` int(10) NOT NULL DEFAULT 0,
  `fwc_iw` int(10) NOT NULL DEFAULT 0,
  `fwc_etei` int(10) NOT NULL DEFAULT 0,
  `fwc_isup` int(10) NOT NULL DEFAULT 0,
  `fwc_isup_pref` int(10) NOT NULL DEFAULT 0,
  `fwc_ia` int(10) NOT NULL DEFAULT 0,
  `fwc_sccpm` int(10) NOT NULL DEFAULT 0,
  `transport_medium` int(10) NOT NULL DEFAULT 0,
  `user_coding_standard` int(10) NOT NULL DEFAULT 0,
  `user_transfer_cap` int(10) NOT NULL DEFAULT 0,
  `user_transfer_mode` int(10) NOT NULL DEFAULT 0,
  `user_transfer_rate` int(10) NOT NULL DEFAULT 0,
  `user_layer1_ident` int(10) NOT NULL DEFAULT 0,
  `user_layer1_proto` int(10) NOT NULL DEFAULT 0,
  `source_ip` varchar(60) NOT NULL DEFAULT '',
  `source_port` int(10) NOT NULL DEFAULT 0,
  `destination_ip` varchar(60) NOT NULL DEFAULT '',
  `destination_port` int(10) NOT NULL DEFAULT 0,
