...
define('ISUP_FIELDS_CAPTURE', "id, date, floor(micro_ts /1000) as milli_ts, micro_ts,method,opc,dpc,cic,method,called_number,called_ton,called_npi,called_inn,calling_number,calling_ton,calling_npi,calling_ni,calling_restrict,calling_screened,calling_category,cause_standard,cause_itu_class,cause_itu_cause,event_num,source_ip,source_port,destination_ip,destination_port,correlation_id,proto,family,type,node");
